 ...
 */
public class GetTasksInProgressIDAsyncTask extends AsyncTask<Void,Void,ArrayList<Integer>> {
    ...
    public GetTasksInProgressIDAsyncTask(User user, GetCallback callBack, ProgressDialog progressDialog) {
        this.user = user;
