 ...
 */
public class DeleteTaskInProgressAsyncTask extends AsyncTask<Void,Void,Void> {
    ...
    public DeleteTaskInProgressAsyncTask(Task task,GetCallback callBack,ProgressDialog progressDialog) {
        this.task = task;
    ...
    protected Void doInBackground(Void... params) {
        ...
        HttpPost post = new HttpPost(SERVER_ADRESS+"DeleteTaskInProgress.php");
        try{
