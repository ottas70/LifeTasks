 ...
 */
public class DeleteFinishedTaskAsyncTask extends AsyncTask<Void,Void,Void> {
    ...
    public DeleteFinishedTaskAsyncTask(Task task, GetCallback callBack, ProgressDialog progressDialog) {
        this.task = task;
    ...
    protected Void doInBackground(Void... params) {
        ...
        HttpPost post = new HttpPost(SERVER_ADRESS+"DeleteFinishedTask.php");
        try{
