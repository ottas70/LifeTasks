 ...
 */
public class StoreTaskInProgressAsyncTask extends AsyncTask<Void,Void,Void> {
    ...
    public StoreTaskInProgressAsyncTask(Task task,GetCallback callBack,ProgressDialog progressDialog) {
        this.task = task;
    ...
    protected Void doInBackground(Void... params) {
        ...
        HttpPost post = new HttpPost(SERVER_ADRESS+"StoreTaskInProgress.php");
        try{
